    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g
          id="Group_6"
          data-name="Group 6"
          transform="translate(-1227.4 -253.1)"
        >
          {" "}
          <path
            id="Path_30"
            data-name="Path 30"
            d="M1280.3,292.9a11.952,11.952,0,0,1-13.4,13.4,12.092,12.092,0,0,1-10.3-10.3,11.952,11.952,0,0,1,13.4-13.4A12.092,12.092,0,0,1,1280.3,292.9Z"
            fill="none"
            stroke="#2b4ea2"
            strokeLinecap="round"
            strokeLinejoin="round"
